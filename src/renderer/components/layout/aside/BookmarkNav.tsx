...
/**
 * Navigation component that displays bookmarked items in a sidebar.
 * Supports both collapsed and expanded states with tooltips and navigation functionality.
 * 
...
export default function BookmarkNav({ collapsed }: { collapsed: boolean }) {
  ...
  /**
   * Renders a bookmark icon with tooltip showing the bookmark summary.
   * Uses filled icon for active bookmarks and regular icon for inactive ones.
   * 
  ...
  /**
   * Renders the list of favorite bookmarks or a hint message if no favorites exist.
   * Each bookmark is displayed as a clickable button with icon and text (when not collapsed).
   * 
   * @returns {JSX.Element[]} Array of bookmark elements or hint message
   */
